				...
				<div class="col-md-12">
					<div class="form-add">
						<input class="form-control" id="myInput" type="text"
							...
							href="/BookStoreOnline/admin/manage/author/add"
						...
						<table class="table">
							<thead class="thead-light">
								<tr>
									<th>#</th>
									<th>Name</th>
									<th style="width: 700px;">Biography</th>
									<th></th>
								</tr>
							</thead>
							<tbody id="myTable">
								<c:forEach items="${authors }" var="author"
									...
									<tr>
										...
										<td><a href="/BookStoreOnline/admin/manage/author/edit?id=${author.id }"
											class="btn btn-primary"><i class="fas fa-edit"></i> Edit</a>
											<a href="javascript:void(0);"
											onclick="Shop.delete('/BookStoreOnline/admin/manage/author/delete?id=${author.id }')"
