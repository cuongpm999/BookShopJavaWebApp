					...
					<div class="form-add">
						...
						<div class="card-body">
							<div class="panel-body">
								<form action="/BookStoreOnline/admin/manage/book/edit"
									...
									<div class="form-group">
										<label class="required">Category: </label> <input
											name="category" class="form-control"
											value="${book.category }" placeholder="Nhập thể loại"/>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label class="required">Language: </label> <input
											...
											value="${book.language }" placeholder="Nhập ngôn ngữ"/>
									</div>
