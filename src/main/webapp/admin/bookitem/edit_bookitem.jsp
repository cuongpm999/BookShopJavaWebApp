					...
					<div class="form-add">
						...
						<div class="card-body">
							<div class="panel-body">
								<form action="/BookStoreOnline/admin/manage/book-item/edit"
									method="post" enctype="multipart/form-data" id="validateForm">
									<input type="hidden" name="barCode" value="${bookItem.barCode}" />
									<input type="hidden" name="img" value="${bookItem.img}" />
									...
									<div class="form-group">
										<label>Discount:</label> <input name="discount"
											class="form-control" placeholder="Nhập giảm giá"
											value="${bookItem.discount }" />
									</div>
									<div class="form-group">
