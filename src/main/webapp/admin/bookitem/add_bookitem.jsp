					...
					<div class="form-add">
						...
						<div class="card-body">
							<div class="panel-body">
								<form action="/BookStoreOnline/admin/manage/book-item/add"
									method="post" enctype="multipart/form-data" id="validateForm">
									...
									<div class="form-group">
										...
										<input name="price" class="form-control" placeholder="Nhập giá tiền" value="${bookItem.price }"/>
									</div>
									<div class="form-group">
										<label>Discount:</label>
										<input name="discount" class="form-control" placeholder="Nhập giảm giá" value="${bookItem.discount }"/>
									</div>
									<div class="form-group">
...
<script type="text/javascript">
	$().ready(function() {
		$('#validateForm').validate({
			...
			messages : {
				price : {
					required : "Please enter price item",
					number : "Price only includes number"
				},
				file : "Please upload img book",
