					...
					<div class="form-add">
						<c:choose>
							<c:when test="${status=='failed'}">
								<div class="alert alert-danger">
									<strong>Failed!</strong> Bạn đã sửa thất bại!
						...
						<div class="card-body">
							<div class="panel-body">
								<form action="/BookStoreOnline/admin/manage/customer/edit"
									...
									<div class="form-group">
										<fmt:formatDate value="${customer.dateOfBirth }"
									...
									<div class="form-group">
										...
										<label class="required">Username:</label> <input
											...
											value="${customer.account.username }" readonly="readonly"/>
									</div>
									...
									<div class="form-group">
										<label class="required">Password:</label> <input
											...
											value="${customer.account.password }" />
									</div>
									
									<div class="form-group">
										<label class="required">Point:</label> <input
											name="point" class="form-control" type="text"
	...
	$().ready(function() {
		$('#validateForm').validate({
			...
			messages : {
				...
				point : {
					required : "Please enter point customer",
					number : "Point only includes number"
				},
			},
		})
	})
