				...
				<div class="col-md-12">
					<div class="form-add">
						<input class="form-control" id="myInput" type="text"
							...
							href="/BookStoreOnline/admin/manage/shipment/add"
							...
							<tbody id="myTable">
								<c:forEach items="${shipments }" var="shipment" varStatus="loop">
									<tr>
										...
										<td><a
											href="/BookStoreOnline/admin/manage/shipment/edit?id=${shipment.id }"
											class="btn btn-primary"><i class="fas fa-edit"></i> Edit</a>
											<a href="javascript:void(0);"
											onclick="Shop.delete('/BookStoreOnline/admin/manage/shipment/delete?id=${shipment.id }')"
