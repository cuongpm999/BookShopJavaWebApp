			...
			<div class="col-md-12" style="padding: 10px;">
				...
				<div class="card-body">
					<div class="panel-body">
						<form action="/BookStoreOnline/edit-profile" method="post" id="profileForm">
							...
							<div class="form-group">
								<label class="required">Point:</label> <input name="point"
									class="form-control" type="text" value="${customer.point }"
									readonly="readonly" />
							</div>
