...
@WebServlet(urlPatterns = "/admin/manage/customer/edit")
public class EditCustomerController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher requestDispatcher = getServletContext()
				.getRequestDispatcher("/admin/customer/edit_customer.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Customer customer = new Customer(mobile, sex, dateOfBirth, fullName, address, account, email, true, point, note);
		customer.setId(id);
