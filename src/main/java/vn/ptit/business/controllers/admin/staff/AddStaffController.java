...
@WebServlet(urlPatterns = "/admin/manage/staff/add")
public class AddStaffController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		RequestDispatcher requestDispatcher = getServletContext()
				.getRequestDispatcher("/admin/staff/add_staff.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Staff staffCheck = staffDAO.findByEmail(email);
		if (staffCheck != null) {
		...
		staffCheck = staffDAO.findByUsername(username);
		if (staffCheck != null) {
